        ...
        <div className="w-full max-w-md space-y-8 bg-gray-300 p-3 rounded-2xl">
          ...
          <div>
              <button
                type="submit"
                onClick={signup}
                className="group relative flex w-full justify-center rounded-md bg-violet-600 px-3 py-2.5 text-sm font-semibold text-white hover:bg-violet-500 focus-visible:outline focus-visible:outline-2 bg-green-600 focus-visible:outline-offset-2 focus-visible:outline-violet-600"
              >
